        ...
        <ScrollView style={styles.container}>
            <View style={styles.main}>
                ...
                <View style={styles.section}>
                    ...
                    <ThemedText style={styles.text}>
                    Nous mettons en place des mesures de sécurité appropriées pour protéger vos données contre tout accès non autorisé.{'\n'}
                    </ThemedText>
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <ThemedText style={styles.text}>
                    NoPestsAllowed permet aux utilisateurs de signaler et de consulter des informations sur la présence de nuisibles à des emplacements spécifiques. L'application utilise la géolocalisation pour fournir ces services.{'\n'}
                    </ThemedText>
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <ThemedText style={styles.text}>
                    Nous nous efforçons de garantir l'exactitude des informations fournies, mais nous ne pouvons être tenus responsables des erreurs ou omissions. Nous nous réservons le droit de supprimer tout contenu inapproprié.{'\n'}
                    </ThemedText>
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <ThemedText style={styles.text}>
                    Tous les contenus de l'application, y compris les textes, images, logos et marques, sont protégés par les lois sur la propriété intellectuelle. Toute reproduction ou utilisation non autorisée est interdite.{'\n'}
                    </ThemedText>
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <ThemedText style={styles.text}>
                    Nous nous réservons le droit de modifier les présentes CGU à tout moment. Les utilisateurs seront informés des modifications via l'application.{'\n'}
                    </ThemedText>
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <ThemedText style={styles.text}>
                    L'utilisation de la géolocalisation nécessite votre consentement explicite. Vous pouvez activer ou désactiver la géolocalisation à tout moment dans les paramètres de votre appareil.{'\n'}
                    </ThemedText>
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <ThemedText style={styles.text}>
                    Les signalements sont faits par les utilisateurs et nous ne garantissons pas leur véracité. Nous nous réservons le droit de vérifier et de supprimer les signalements faux ou malveillants. {'\n'}
                    </ThemedText>
                </View>
                ...
                <View style={styles.section}>
                    ...
                    <ThemedText style={styles.text}>
                    Les utilisateurs sont responsables des informations qu'ils fournissent. En cas de signalement intentionnellement faux, l'utilisateur peut être tenu responsable et voir son compte suspendu ou supprimé.{'\n'}
                    </ThemedText>
                </View>
